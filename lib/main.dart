...
class ProjectState extends ChangeNotifier {
  ...
  final GlobalKey canvasKey = GlobalKey(); // Added key for dynamic canvas sizing
  ...
  Future<void> _writeToDisk(String path) async {
    final Map<String, dynamic> projectData = {
      'version': 17, 'name': _projectName, 'unit_label': _unitLabel,
  ...
  // Updated jumpToNode with dynamic centering
  ...
  Widget build(BuildContext context) {
    ...
    return CallbackShortcuts(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData.dark().copyWith(scaffoldBackgroundColor: const Color(0xFF111111), cardColor: const Color(0xFF222222)),
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children:[
            Image.asset('assets/logo.png', height: 200), const SizedBox(height: 5),
            const Text("Node Writer 1.0", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
...
class _NodeCanvasState extends State<NodeCanvas> {
  ...
  Widget build(BuildContext context) {
    final state = context.read<ProjectState>();
    return Listener(
      key: state.canvasKey, // Added canvasKey right here!
          ...
          child: Row(
            children:[
              ...
              IconButton(
                ...
                onPressed: () {
                  Clipboard.setData(ClipboardData(text: _getCompiledRawText(nodes)));
              ...
              IconButton(
                ...
                onPressed: () async {
                  ...
                  if (outputFile != null) {
                    ...
                    await File(outputFile).writeAsString(_getCompiledRawText(nodes));
          ...
          child: SelectionArea(
            child: ListView.builder(
              ...
              itemBuilder: (ctx, i) {
                ...
                // Fetch the sequence number to display like "#2 SCENE TITLE"
